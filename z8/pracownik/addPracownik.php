...
if($passagain != $pass){
    header("Location: http://marianowas11.beep.pl/z8/pracownik/errorhaslopowtorz.php");
 ...
 if (mysqli_num_rows($res_u) > 0) {
    header("Location: http://marianowas11.beep.pl/z8/pracownik/errorLoginZajety.php");
 ...
 mkdir($user);
    ...
    header("Location: http://marianowas11.beep.pl/z8/pracownik/pracownikLogin.php");
